...
public class MyChangeListsPanelCategory extends BasePanelCategory {

	@Override
	public String getKey() {
		return CTPanelCategoryKeys.CONTROL_PANEL_MY_CHANGE_LISTS;
	}
	...
	public String getLabel(Locale locale) {
		...
		return LanguageUtil.get(resourceBundle, "my-change-lists");
	}
